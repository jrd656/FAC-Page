...
var textInput = document.querySelector('#text1');

let msgCard = document.getElementById('message-card');
let email = document.getElementsByClassName('message-email');
let name = document.getElementsByClassName('message-name');
let messageText = document.getElementsByClassName('message-text');
