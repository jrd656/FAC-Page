...
fetch(req)
    ...
    .then( (jsonData) =>{
        ...
        document.getElementById('changeText').textContent = scoreCodeWars;
        document.getElementById('CWscore').textContent = scoreCodeWars +"/250 points on CodeWars!";
    })
    .catch( (err) =>{
        console.log('ERROR:', err.message);
    });
...
fetch(req)
    ...
    .then( (jsonData) =>{
        ...
        scoreCodeWars = jsonData.honor;
        document.getElementById('changeText').textContent = scoreCodeWars;
        document.getElementById('FCCscore').textContent = scoreCodeWars +"/250 points on FreeCodeCamp!";
    })
    .catch( (err) =>{
        console.log('ERROR:', err.message);
    });
