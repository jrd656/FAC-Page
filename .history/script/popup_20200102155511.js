...
window.addEventListener("scroll", function() {
    ...
    if (offset < 2400) {
        ...
        console.log("We're not as far down as 2400" + "distance to top of delphi: "+ elDistanceToTop1); 
    }

    if (offset > 2800) {
        popupdiv.style.display = "inline-block";
        console.log("We're beyond 2000"+ "distance to top of delphi: "+ elDistanceToTop1); 
    }
